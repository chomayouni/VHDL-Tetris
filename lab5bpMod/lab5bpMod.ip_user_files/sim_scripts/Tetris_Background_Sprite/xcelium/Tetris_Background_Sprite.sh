...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.Tetris_Background_Sprite xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.Tetris_Background_Sprite -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Tetris_Background_Sprite_sc.so .tmp_log xcelium_lib waves.shm c.obj)
