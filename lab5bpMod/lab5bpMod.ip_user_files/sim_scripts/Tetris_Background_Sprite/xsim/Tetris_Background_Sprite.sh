...
#
# Script generated by Vivado on Thu Nov 30 12:01:08 -0500 2023
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : Tetris_Background_Sprite.sh
...
#
# Usage        : Tetris_Background_Sprite.sh
#                Tetris_Background_Sprite.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Tetris_Background_Sprite.sh [-reset_run]
#                Tetris_Background_Sprite.sh [-reset_log]
#                Tetris_Background_Sprite.sh [-help]
#
...
# script info
echo -e "Tetris_Background_Sprite.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Tetris_Background_Sprite.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Tetris_Background_Sprite xil_defaultlib.Tetris_Background_Sprite xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Tetris_Background_Sprite -key {Behavioral:sim_1:Functional:Tetris_Background_Sprite} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Tetris_Background_Sprite.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Tetris_Background_Sprite.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Tetris_Background_Sprite.sh [-help]\n\
Usage: Tetris_Background_Sprite.sh [-step]\n\
Usage: Tetris_Background_Sprite.sh [-lib_map_path]\n\
Usage: Tetris_Background_Sprite.sh [-reset_run]\n\
Usage: Tetris_Background_Sprite.sh [-reset_log]\n\
Usage: Tetris_Background_Sprite.sh [-keep_index]\n\
Usage: Tetris_Background_Sprite.sh [-noclean_files]\n\n\
