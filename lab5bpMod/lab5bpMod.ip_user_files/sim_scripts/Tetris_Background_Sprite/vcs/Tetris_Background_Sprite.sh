...
#                script (type 'Tetris_Background_Sprite.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Tetris_Background_Sprite xil_defaultlib.glbl -o Tetris_Background_Sprite_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Tetris_Background_Sprite_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key Tetris_Background_Sprite_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Tetris_Background_Sprite_simv.daidir vcs_lib c.obj)
