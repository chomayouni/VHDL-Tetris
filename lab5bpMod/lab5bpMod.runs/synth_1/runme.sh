...
HD_PWD='C:/Users/conno/Downloads/lab5Complete/lab5bpModBounce/lab5bpMod/lab5bpMod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Tetris_VGA_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Tetris_VGA_Top.tcl
