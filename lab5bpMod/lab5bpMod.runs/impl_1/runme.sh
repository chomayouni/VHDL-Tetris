...
HD_PWD='C:/Users/conno/Downloads/lab5Complete/lab5bpModBounce/lab5bpMod/lab5bpMod.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Tetris_VGA_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Tetris_VGA_Top.tcl -notrace
