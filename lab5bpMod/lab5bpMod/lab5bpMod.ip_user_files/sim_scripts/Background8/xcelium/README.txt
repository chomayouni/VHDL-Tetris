...
#
# Generated by export_simulation on Sun Oct 22 17:42:08 -0400 2023
#
################################################################################
...
'-reset_run' switch to the './Background8.sh' script.

./Background8.sh -reset_run
...
./Background8.sh -noclean_files

For more information on the script, please type './Background8.sh -help'.
