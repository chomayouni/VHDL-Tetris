...
HD_PWD='C:/Users/JohnAdmin/Desktop/College/ECE4710/incompletelabs/lab5/lab5bpMod/lab5bpMod.runs/Background8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Background8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Background8.tcl
