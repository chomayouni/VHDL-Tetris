...
HD_PWD='C:/Users/conno/Downloads/lab5bpMod/lab5bpMod/lab5bpMod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log group_photos_top3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source group_photos_top3.tcl
